...
- Optimized time to resize pizza. Placed pizza-width-calculation outside the for-loop that iterates through all pizzas and changes its size.
- Improved initial page load by resizing pizzeria.jpg.
- Improved time to generate pizzas on load. Placed the document.getElementById("randomPizzas") outside for loop.
